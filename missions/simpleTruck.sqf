...
_hint = parseText format ["<t align='center'><img size='5' image='images\blacklist_icon.paa'/></t><br/><t align='center' color='%5' size='1.25'>%1</t><br/><t align='center'><img size='5' image='%2'/></t><br/><t align='center' color='%5'>Enemies are taking delivery of a<t color='%4'> %3</t>.</t>", "BMP-1 Delivery", _picture, _vehicleName, "#52bf90", "#FFFFFF"];
hint _hint;
